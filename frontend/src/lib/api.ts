...
export async function fetchMQTTStatus(): Promise<{ mqtt_online: boolean; broker: string; last_active?: string; recent?: Array<{ sensor: string; value: number; unit: string; timestamp: string }> }> {
